...
public class TestBase {
    ...
    public void beforeSuite(ITestContext context) {
        ...
        String reportName = properties.getProperty(PropertyConstants.REPORT_NAME).concat(".html"); // AutomationReport.html
        // Generating Extent reports
        generateExtentReport(Constants.REPORT_DIR + reportName, context.getSuite().getName());
        ...
        if (result.getStatus() == ITestResult.FAILURE) {
            ...
            if (Boolean
                ...
                try {
                    ...
                    Reporter.log("Screenshot has taken.");
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
    ...
    private void generateExtentReport(String reportFilePath, String suiteName) {
        if (null == extent) {
            Reporter.log("Extent report location - " + reportFilePath, true);
